 ...
 */
export function getDeviceInfo(c: Context): { ipAddress?: string; userAgent?: string } {
  return {
 ...
 */
export function handleAuthError(c: Context, error: unknown, logger: { error: (obj: object, msg: string) => void }, formatError: (err: unknown) => unknown, contextMessage: string) {
