...
describe("WebSocket Integration Tests", () => {
  ...
  describe("Authentication", () => {
    ...
    it("should reject user not in company", () => {
      ...
      const errorEvent = createAuthErrorEvent(
  ...
  describe("Event Broadcasting", () => {
    ...
    it("should not leak events to other companies", () => {
      const wsCompanyA = createMockWebSocket({
        authenticated: true,
        companyId: "company-a",
      });
      const wsCompanyB = createMockWebSocket({
        authenticated: true,
        companyId: "company-b",
      });
    ...
    it("should handle closed connections gracefully", () => {
      const wsOpen = createMockWebSocket({
        authenticated: true,
        companyId: "company-a",
      });
      const wsClosed = createMockWebSocket({
        authenticated: true,
        companyId: "company-a",
      });
  ...
  describe("QR Code Flow", () => {
    ...
    it("should receive connected event after QR scan", () => {
      ...
      expect(message?.payload).toHaveProperty(
        "jid",
        "1234567890@s.whatsapp.net",
      );
    });
  ...
  describe("Message Events", () => {
    ...
    it("should broadcast message:status updates", () => {
      ...
      const statusEvent = createMessageStatusEvent(
        "conn-123",
        "msg-123",
        "conv-456",
        "delivered",
