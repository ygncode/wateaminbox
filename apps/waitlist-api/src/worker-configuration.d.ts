/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --env-interface=CloudflareBindings ./src/worker-configuration.d.ts` (hash: c24bd419c6668fc4e832f8ee067dfb3e)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	EMAIL: SendEmail;
	ENVIRONMENT: "production";
	ALLOWED_ORIGINS: "https://wateaminbox.com";
	MARKETING_ORIGIN: "https://wateaminbox.com";
	PUBLIC_API_ORIGIN: "https://waitlist-api.wateaminbox.com";
	WAITLIST_FROM_EMAIL: "WATeamInbox <noreply@wateaminbox.com>";
