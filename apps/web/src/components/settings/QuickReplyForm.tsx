    ...
    <>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              value={shortcut}
              onChange={(e) =>
                onShortcutChange(e.target.value.toLowerCase().replace(/[^a-z0-9_-]/g, ''))
              }
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <Button
            type="submit"
            disabled={isSubmitting || !shortcut.trim() || !title.trim() || !content.trim()}
          ...
          >
            {isSubmitting ? (
              <>
                ...
                {isEditing ? t('common.saving', 'Saving...') : t('common.creating', 'Creating...')}
              </>
            ) : (
              <>
