...
export function MobileHeader({
  ...
  return (
    <header
      className={cn(
        "flex h-14 min-h-[56px] items-center gap-2 border-b border-gray-200 bg-gray-100 px-2 safe-area-top",
        className,
      )}
      {...props}
    >
      {showBackButton && (
        <button
          onClick={handleBack}
          className="flex h-11 w-11 items-center justify-center rounded-full text-gray-600 hover:bg-gray-200 active:bg-gray-300 transition-colors touch-manipulation"
          aria-label="Go back"
        >
...
export function MobileSlideInPanel({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 z-50 flex w-full max-w-[320px] flex-col bg-white shadow-xl transition-transform duration-300 ease-in-out safe-area-left safe-area-right",
      ...
      >
        {/* Panel Header */}
        {(title || onClose) && (
          <header className="flex h-14 min-h-[56px] items-center gap-2 border-b border-gray-200 bg-whatsapp-teal-green px-4 text-white safe-area-top">
            {onClose && (
              <button
                onClick={onClose}
...
export function MobileActionButton({
  ...
  return (
    <button
      className={cn(
        "flex h-11 w-11 items-center justify-center rounded-full text-gray-600 hover:bg-gray-200 active:bg-gray-300 transition-colors touch-manipulation",
        className,
      )}
      aria-label={label}
      {...props}
