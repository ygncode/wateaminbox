...
export function MainContent({
  ...
  return (
    <main
      className={cn("flex flex-1 flex-col bg-gray-50", className)}
      {...props}
    >
      {children}
    </main>
...
export function MessageInputArea({
  ...
  return (
    <footer
      className={cn(
        "flex items-center gap-2 border-t border-gray-200 bg-gray-100",
        // Responsive padding
...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        "flex flex-1 flex-col items-center justify-center bg-gray-100 text-center",
        className,
      )}
      {...props}
    >
