...
export function AnalyticsConsent() {
  ...
  return (
    ...
    >
      <h2 className="text-sm font-semibold">Anonymous usage analytics</h2>
      <p className="mt-1.5 text-xs leading-5 text-[#65736d] dark:text-dark-text-secondary">
        This deployment can collect anonymous page and feature usage through
        Google Analytics to improve the product. No messages, contacts, or
        account identifiers are ever sent. You can change this choice anytime in
        Settings under Privacy &amp; analytics.
      </p>
