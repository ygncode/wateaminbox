    ...
    <div className="flex flex-col items-center gap-4 bg-gray-50 py-8">
      ...
      <div className="text-center">
        ...
        {contact.customName && contact.pushName && (
          <p className="text-sm text-gray-500">~{contact.pushName}</p>
        )}
      </div>
    </div>
  );
        ...
        {contact.pushName && (
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">WhatsApp Name</p>
            </div>
          </div>
        )}
      </div>
          ...
          {isEditing ? (
            <div className="space-y-2">
              <textarea
                ...
                className="w-full rounded-md border border-gray-300 p-2 text-sm focus:border-whatsapp-teal-green focus:outline-none focus:ring-1 focus:ring-whatsapp-teal-green"
                rows={4}
                autoFocus
              />
            ...
            >
              ...
              <Edit2 className="mt-1 h-3 w-3 text-gray-400 opacity-0 transition-opacity group-hover:opacity-100" />
            </div>
          )}
        </div>
      </div>
        ...
        <div className="flex-1">
          <div className="flex flex-wrap gap-2">
            {contact.tags.map((tag) => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-1 rounded-full p-0.5 opacity-0 transition-opacity hover:bg-black/10 group-hover:opacity-100"
                >
                  <X className="h-3 w-3" />
                </button>
              </Badge>
            ...
            <button
              ...
              className="flex h-6 items-center gap-1 rounded-full border border-dashed border-gray-300 px-2 text-xs text-gray-500 hover:border-gray-400 hover:text-gray-600"
            >
          ...
          >
            <div className="mt-0.5">
              <History
                className={cn(
                  "h-4 w-4",
                  entry.isActive ? "text-green-600" : "text-gray-400",
                )}
              />
            </div>
