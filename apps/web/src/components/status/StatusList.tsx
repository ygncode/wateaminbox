      ...
      <ScrollArea className="flex-1">
        ...
        {isError && (
          <div className="flex flex-col items-center justify-center h-48 px-4 text-center">
            <Circle className="w-12 h-12 text-gray-400 mb-4" />
            <p className="text-gray-600 font-medium">Failed to load status</p>
        ...
        {!isLoading && !isError && (!statuses || statuses.length === 0) && (
          <div className="flex flex-col items-center justify-center h-48 px-4 text-center">
            <Circle className="w-12 h-12 text-gray-400 mb-4" />
            <p className="text-gray-600 font-medium">No status updates</p>
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-1 text-sm text-gray-500">
          ...
          {totalStatuses > 1 && (
            <span className="text-gray-400">({totalStatuses} updates)</span>
          )}
        </div>
      </div>
