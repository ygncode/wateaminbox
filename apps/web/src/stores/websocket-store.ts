...
export const selectIsConnecting = (state: WebSocketState) => state.status === 'connecting'
export const selectIsDisconnected = (state: WebSocketState) => state.status === 'disconnected'
