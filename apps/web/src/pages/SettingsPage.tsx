...
export function SettingsPage() {
  ...
  return (
    <AppLayout>
      <div className="flex h-full w-full flex-col bg-gradient-to-br from-gray-50 to-gray-100">
        {/* Top Navigation Bar */}
...
function QuickLink({
  ...
  return (
    ...
    >
      ...
      <ChevronRight className="h-5 w-5 text-gray-400 group-hover:text-[#25D366] group-hover:translate-x-1 transition-all" />
    </Link>
  );
}
