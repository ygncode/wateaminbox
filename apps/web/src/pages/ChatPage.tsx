...
export function ChatPage() {
  ...
  const selectedContact = contactDetail ? mapContactDetailToContact(contactDetail) : undefined
  ...
  const sidebar = (
    <Sidebar className="w-full md:w-[350px] lg:w-[400px] flex-shrink-0">
      <ChatSidebar selectedChatId={selectedChatId} onChatSelect={handleChatSelect} />
    </Sidebar>
  )
