...
export function registerEventHandlers(
  ...
  unsubscribes.push(
    client.on<MessageReactionPayload>("message:reaction", (payload) => {
      logger.debug("Message reaction update:", {
      ...
      // Update TanStack Query cache for real-time reaction updates
      updateMessageInCache(
        queryClientRef.current,
        payload.contactId, // contactId is used as conversationId
        payload.messageId,
        (msg) => {
