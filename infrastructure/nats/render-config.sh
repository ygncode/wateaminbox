      ...
      permissions: {
        publish: {
          ...
          deny: [
            ...
            "\$JS.API.CONSUMER.INFO.WHATSAPP_COMMANDS.orchestrator-commands",
            "\$JS.API.CONSUMER.CREATE.WHATSAPP_COMMANDS.orchestrator-commands",
            "\$JS.API.CONSUMER.CREATE.WHATSAPP_COMMANDS.orchestrator-commands.>",
            "\$JS.API.CONSUMER.DURABLE.CREATE.WHATSAPP_COMMANDS.orchestrator-commands",
            "\$JS.API.CONSUMER.UPDATE.WHATSAPP_COMMANDS.orchestrator-commands",
            "\$JS.API.CONSUMER.UPDATE.WHATSAPP_COMMANDS.orchestrator-commands.>",
            "\$JS.API.CONSUMER.DELETE.WHATSAPP_COMMANDS.orchestrator-commands",
            "\$JS.API.CONSUMER.MSG.NEXT.WHATSAPP_COMMANDS.orchestrator-commands",
            "\$JS.API.CONSUMER.MSG.NEXT.WHATSAPP_COMMANDS.orchestrator-commands.>",
            "\$JS.ACK.WHATSAPP_COMMANDS.orchestrator-commands.>",
            "\$JS.API.CONSUMER.INFO.WHATSAPP_EVENTS.whatsapp-api-events-v1",
            "\$JS.API.CONSUMER.CREATE.WHATSAPP_EVENTS.whatsapp-api-events-v1",
            "\$JS.API.CONSUMER.CREATE.WHATSAPP_EVENTS.whatsapp-api-events-v1.>",
            "\$JS.API.CONSUMER.DURABLE.CREATE.WHATSAPP_EVENTS.whatsapp-api-events-v1",
            "\$JS.API.CONSUMER.UPDATE.WHATSAPP_EVENTS.whatsapp-api-events-v1",
            "\$JS.API.CONSUMER.UPDATE.WHATSAPP_EVENTS.whatsapp-api-events-v1.>",
            "\$JS.API.CONSUMER.DELETE.WHATSAPP_EVENTS.whatsapp-api-events-v1",
            "\$JS.API.CONSUMER.MSG.NEXT.WHATSAPP_EVENTS.whatsapp-api-events-v1",
            "\$JS.API.CONSUMER.MSG.NEXT.WHATSAPP_EVENTS.whatsapp-api-events-v1.>",
            "\$JS.ACK.WHATSAPP_EVENTS.whatsapp-api-events-v1.>",
