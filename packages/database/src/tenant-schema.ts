...
export const TENANT_SCHEMA_CONTRACT = {
  ...
  whatsapp_attachment_fetch_state: [
    "attachment_id",
    "direct_path",
    "media_key",
    "file_sha256",
  ...
  contact_endpoint_reassignment_events: [
    "id",
    "merge_event_id",
    "contact_endpoint_id",
    "previous_contact_id",
  ...
  channel_spine_backfill_checkpoints: [
    "job_key",
    "phase",
    "cursor",
    "rows_processed",
...
export async function reconcileTenantSchema<Database>(
  ...
  // Migration 092 parity. This is additive and creates no rows, so legacy
  // reads/writes remain authoritative until workspace flags enable later
  // phases.
